! function(n) {
	n.fn.swipeslider = function(i) {
		...
		function E() {
			B.after('<span class="sw-next-prev sw-prev icon iconfont">&#xe606;</span>'), D.find(".sw-prev").click(function() {
				L && (l(), w(), a())
			}), B.after('<span class="sw-next-prev icon iconfont sw-next">&#xe605;</span>'), D.find(".sw-next").click(function() {
				L && (l(), d(), a())
			})
		}
